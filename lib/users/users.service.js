...
const UserAlreadyExistsException_1 = require("../exceptions/UserAlreadyExistsException");
...
let UsersService = exports.UsersService = (() => {
    ...
    var UsersService = _classThis = class {
        ...
        async create(createUserDto) {
            ...
            return this.usersRepository.create(Object.assign(Object.assign({}, createUserDto), { password: hashedPassword }));
        }
        ...
        async updateUserAccountStatus(updateUserAccountStatusDto) {
            ...
            return this.usersRepository.updateUserStatusByEmail(updateUserAccountStatusDto.userEmail, updateUserAccountStatusDto.status);
        }
        async verifyIsUserAdmin(adminEmail) {

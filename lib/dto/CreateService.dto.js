...
let CreateServiceDto = exports.CreateServiceDto = (() => {
    var _a;
    ...
    return _a = class CreateServiceDto {
            constructor() {
        ...
        (() => {
            _serviceName_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MinLength)(5)];
            _userEmail_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.IsEmail)()];
...
//# sourceMappingURL=CreateService.dto.js.map
...
let CreatePetDto = exports.CreatePetDto = (() => {
    var _a;
    ...
    return _a = class CreatePetDto {
        ...
        (() => {
            _petName_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petAge_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _petImageLink_decorators = [(0, class_validator_1.IsString)()];
            _petType_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petBreed_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petGender_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petBloodPressure_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petBoneDensity_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _petWeight_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsNotEmpty)()];
            _petOwner_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
...
//# sourceMappingURL=CreatePet.dto.js.map
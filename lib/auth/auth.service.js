...
const AccountIsNotValidException_1 = require("../exceptions/AccountIsNotValidException");
let AuthService = exports.AuthService = (() => {
    ...
    var AuthService = _classThis = class {
        ...
        async validateUser(loginUserDto) {
            ...
            if (user) {
                ...
                if (!isAccountStatusValid) {
                    throw new AccountIsNotValidException_1.AccountIsNotValidException();
                }
                if (!isPasswordValid) {
        ...
        async updateUserAccountStatus(updateUserAccountStatusDto) {
            return this.usersService.updateUserAccountStatus(updateUserAccountStatusDto);
        }
